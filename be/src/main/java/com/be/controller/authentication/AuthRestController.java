package com.be.controller.authentication;

import com.be.dto.request.ChangePasswordRequest;
import com.be.dto.request.RegisterForm;
import com.be.dto.request.ResetPasswordRequest;
import com.be.dto.request.SignInForm;
import com.be.dto.response.JwtResponse;
import com.be.dto.response.ResponseMessage;
import com.be.dto.user.UserMailDTO;
import com.be.dto.user.UserOtpDTO;
import com.be.model.user.Role;
import com.be.model.user.User;
import com.be.security.JwtTokenProvider;
import com.be.security.UserPrinciple;
import com.be.service.mail.IEmailService;
...
public class AuthRestController {
    ...
    @GetMapping("/getUser")
    public ResponseEntity getUser(@RequestParam("idCustomer") Integer idCustomer){
